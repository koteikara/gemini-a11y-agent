---
type: A11y Rule
title: IMG-W-02 iframe title
description: iframe titleに関するアクセシビリティ対応ルール。
...
# IMG-W-02 iframe title

## 目的

HTML断片内の「iframe title」に関するアクセシビリティ上の懸念を見つけ、人間が安全に判断できる候補へ整理する。
