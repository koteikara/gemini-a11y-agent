...
FEATURE_HYBRID_RULES_REPORT = os.environ.get("FEATURE_HYBRID_RULES_REPORT", "0") == "1"
HYBRID_RULES_JSONL_PATH = os.environ.get("HYBRID_RULES_JSONL_PATH", "")
HYBRID_RULES_REPORT_MAX_PREVIEW = int(os.environ.get("HYBRID_RULES_REPORT_MAX_PREVIEW", "240"))
